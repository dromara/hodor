...
CREATE TABLE `hodor_job_info` (
  ...
  `schedule_strategy` int(11) CHARACTER SET utf8 NOT NULL DEFAULT 0 COMMENT '调度策略, 0: random, 1: round_robin, 2: lowest_load, 3: broadcast, 4: specify_actuator',
  ...
  `broadcast` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否广播模式 0：否，1：是；默认0',
  ...
  `actuator_ip` varchar(32) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '该job被分配到slave的IP',
