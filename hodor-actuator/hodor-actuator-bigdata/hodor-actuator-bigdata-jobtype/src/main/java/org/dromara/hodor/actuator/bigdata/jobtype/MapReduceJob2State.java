...
/**
 * Container that holds state of a MapReduce job for hadoop 2.x
 */
public class MapReduceJob2State {
  ...
  public MapReduceJob2State() {
  }

  public MapReduceJob2State(String jobId, String jobName, String trackingURL,
  ...
  public MapReduceJob2State(Job runningJob, TaskReport[] mapTaskReport,
                            TaskReport[] reduceTaskReport) throws IOException {
    jobId = runningJob.getJobID().toString();
    ...
    failureInfo = runningJob.getSchedulingInfo();
  ...
  public Object toJson() {
    ...
    String countersString =
        (counters != null) ? CountersStrings.toEscapedCompactString(counters) : "";
    jsonObj.put("countersString", countersString);
    return jsonObj;
  }

  @SuppressWarnings("unchecked")
  public static MapReduceJob2State fromJson(Object obj) throws Exception {
    ...
    Counters counters1 = CountersStrings.parseEscapedCompactString(countersString, counters);

    return new MapReduceJob2State(jobId, jobName, trackingUrl, failureInfo,
        ...
        finishedReducersCount, counters1);
  }
}
