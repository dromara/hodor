...
package org.dromara.hodor.actuator.bigdata.security;
...
import org.dromara.hodor.actuator.bigdata.core.executor.Constants;
...
import org.dromara.hodor.actuator.bigdata.core.utils.ExecuteAsUser;
import org.dromara.hodor.actuator.api.utils.Props;
import org.dromara.hodor.common.exception.UndefinedPropertyException;

import static org.apache.hadoop.hive.metastore.api.hive_metastoreConstants.META_TABLE_STORAGE;
import static org.dromara.hodor.actuator.bigdata.core.executor.Constants.ConfigurationKeys.AZKABAN_SERVER_NATIVE_LIB_FOLDER;
import static org.dromara.hodor.actuator.bigdata.core.executor.Constants.JobProperties.EXTRA_HCAT_CLUSTERS;
import static org.dromara.hodor.actuator.bigdata.core.executor.Constants.JobProperties.EXTRA_HCAT_LOCATION;
...
public class HadoopSecurityManager_H_2_0 extends HadoopSecurityManager {
  ...
  public UserGroupInformation getProxiedUser(final Props userProp)
      throws HadoopSecurityManagerException {
    final String userToProxy = verifySecureProperty(userProp, Constants.JobProperties.USER_TO_PROXY);
  ...
  public void prefetchToken(final File tokenFile, final Props props, final Logger logger)
      throws HadoopSecurityManagerException {
    final String userToProxy = props.getString(Constants.JobProperties.USER_TO_PROXY);

    logger.info("Getting hadoop tokens based on props for " + userToProxy);
    doPrefetch(tokenFile, props, logger, userToProxy);
  }

  private synchronized void doPrefetch(File tokenFile, final Props props, final Logger logger,
                                       final String userToProxy) throws HadoopSecurityManagerException {
    ...
    try {
      getProxiedUser(userToProxy).doAs(new PrivilegedExceptionAction<Void>() {
        ...
        private void getToken(final String userToProxy) throws InterruptedException,
          ...
          if (props.getBoolean(Constants.JobProperties.ENABLE_JOB_SSL, false)) {
