...
package org.dromara.hodor.actuator.bigdata.security.commons;
...
public class SecurityUtils {
  ...
  public static UserGroupInformation getProxiedUser(final Properties prop,
    ...
    final String toProxy = verifySecureProperty(prop, Constants.JobProperties.USER_TO_PROXY, log);
  ...
  public static synchronized void prefetchToken(final File tokenFile,
    ...
    logger.info("Getting proxy user for " + p.getString(Constants.JobProperties.USER_TO_PROXY));
        ...
        new PrivilegedExceptionAction<Void>() {
          ...
          private void getToken(final Props p) throws InterruptedException,
            ...
            if (shouldPrefetch != null && shouldPrefetch.equals("true")) {
              ...
              final Token<?> fsToken =
                  fs.getDelegationToken(p.getString(Constants.JobProperties.USER_TO_PROXY));
