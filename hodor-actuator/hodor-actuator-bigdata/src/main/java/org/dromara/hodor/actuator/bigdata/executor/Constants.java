...
public class Constants {
  ...
  public static final Duration DEFAULT_FLOW_TRIGGER_MAX_WAIT_TIME = Duration.standardDays(10);

  public static final Duration MIN_FLOW_TRIGGER_WAIT_TIME = Duration.standardMinutes(1);
