...
package org.dromara.hodor.actuator.common.utils;
...
public class Props {
    ...
    public void put(final File propertiesFile) {
    ...
    /**
     * Put all properties in the string into the current props.<br/>
     * eg: <br/>
     * command=echo "test1"<br/>
     * command.1=echo "test2"<br/>
     * command.2=echo "test3"<br/>
     */
    ...
    public Map<String, String> getMapByPrefix(final String prefix) {
        final Map<String, String> values = this._parent == null ? new HashMap<String, String>() :
