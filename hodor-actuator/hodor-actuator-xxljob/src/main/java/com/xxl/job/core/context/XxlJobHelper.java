...
public class XxlJobHelper {
    ...
    public static boolean log(String appendLogPattern, Object... appendLogArguments) {
        ...
        return logDetail(callInfo, appendLog, false);
    }
    ...
    public static boolean log(Throwable e) {
        ...
        StackTraceElement callInfo = new Throwable().getStackTrace()[1];
        return logDetail(callInfo, appendLog, true);
    }
     ...
     * @param appendLog
     */
    private static boolean logDetail(StackTraceElement callInfo, String appendLog, boolean isError) {
        XxlJobContext xxlJobContext = XxlJobContext.getXxlJobContext();
        if (xxlJobContext == null) {
            return false;
        }

        final JobLogger jobLogger = xxlJobContext.getJobLogger();
        ...
        // appendlog
        if (isError) {
            jobLogger.error(formatAppendLog);
        } else {
            jobLogger.info(formatAppendLog);
        }
        return true;
    }
