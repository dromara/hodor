 ...
 */
public class HodorRaftSnapshotInfo implements SnapshotInfo {

  private static final Logger LOG = LoggerFactory.getLogger(HodorRaftSnapshotInfo.class);
  ...
  public HodorRaftSnapshotInfo() { }

  public HodorRaftSnapshotInfo(long term, long index) {
    this.term = term;
