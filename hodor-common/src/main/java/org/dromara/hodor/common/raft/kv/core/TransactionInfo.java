...
import static org.dromara.hodor.common.raft.kv.core.KVConstant.TRANSACTION_INFO_SPLIT_KEY;
...
public final class TransactionInfo {
  ...
  public static TransactionInfo readTransactionInfo(
      ...
      byte[] bytes = metadataManager.getTransactionInfoTable()
          .get(BytesUtil.writeUtf8(TRANSACTION_INFO_KEY));
      if (bytes == null) {
          return null;
      }
  ...
  public SnapshotInfo toSnapshotInfo() {
    return new HodorKVSnapshotInfo(term, transactionIndex);
  }
