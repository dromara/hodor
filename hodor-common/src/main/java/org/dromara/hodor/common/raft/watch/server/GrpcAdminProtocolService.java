...
public class GrpcAdminProtocolService extends AdminProtocolServiceImplBase {
  ...
  @Override
  public void snapshotManagement(RaftProtos.SnapshotManagementRequestProto proto,
                                 StreamObserver<RaftClientReplyProto> responseObserver) {
  ...
  @Override
  public void leaderElectionManagement(RaftProtos.LeaderElectionManagementRequestProto proto,
                                       StreamObserver<RaftClientReplyProto> responseObserver) {
