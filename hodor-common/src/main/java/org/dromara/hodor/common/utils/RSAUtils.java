...
public class RSAUtils {
     ...
     * @return
     */
    public static PrivateKey fileToPrivateKey(String privateKeyFile) throws Exception {
        File key = new File(privateKeyFile);
        try (FileInputStream is = new FileInputStream(key); FileChannel channel = is.getChannel();) {
     ...
     * @return
     */
    public static PrivateKey fileToPrivateKey(String privateKeyFile, String password) throws Exception {
        File key = new File(privateKeyFile);
     ...
     * @throws Exception
     */
    public static boolean verify(byte[] data, String publicKey,
