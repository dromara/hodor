...
public class FlowJobExecDetailServiceTest extends BaseTest {
    ...
    @Resource
    private FlowJobExecDetailService flowJobExecDetailService;

    @Test
    public void testGetExecFlowData() {
        FlowJobExecDetail runningFlowJobExecDetail = flowJobExecDetailService.getRunningFlowJobExecDetail(JobKey.of("test", "flow_name"));
